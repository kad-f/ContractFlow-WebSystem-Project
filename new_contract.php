        ...
        <fieldset>
            ...
            <ul class="form-flex-outer">
                <li>
                    ...
                    <textarea rows="6" name="payment_terms" id="payment_terms" placeholder="Payment Terms"></textarea>
                </li>
                <li>
                ...
                <script>
                    function addPaymentEntry() {
                        ...
                        var paymentTermsTemplate = "Payment Method: " + paymentType + "\n" +
                            "Payment Day: " + paymentDay + "\n" +
                            "Payment Date: " + date + "\n" +
                            "Payment Description: " + description + "\n" +
                            "Payment Schedule: " + paymentDay + "\n" + // Add this line
                            "Annual Spend: " + spend + "\n" +
                            "Status: " + status;
        ...
        <fieldset>
            ...
            <ul class="form-flex-outer">
                ...
                <li>
                    ...
                    <textarea rows="5" name="renewal_conditions" id="renewal_conditions" placeholder="Enter renewal conditions"></textarea>
                </li>
...
if (isset($_POST['create_contract'])) {
   ...
   $date = mysqli_real_escape_string($conn, $_POST['date']);
    ...
    if (mysqli_num_rows($check_contract_result) > 0) {
        ...
        $insert_contract = "INSERT INTO contract(contract_no, contract_name, description, date_of_agreement, supplier_name, life_of_contract, vendor_id, sdm_id, annual_spend, payment_type, payment_terms, status, expiration_id, created_at) VALUES ('$reference_num', '$contract_name', '$description', '$date', '$supplier', '$life', '$vendor_id', '$sdm_id', '$spend', '$payment_type', '$terms', '$status', '$expiration_id', '$created_at')";
